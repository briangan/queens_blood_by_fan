...
class CardAbility < ApplicationRecord
  ...
  WHICH_VALUES = %w[allies_on_affected_tiles enemies_on_affected_tiles allies_and_enemies_on_affected_tiles enhanced_allies enhanced_enemies enfeebled_allies enfeebled_enemies empty_positions]
